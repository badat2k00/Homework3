   ...
   <div className="flex justify-center items-center bg-black h-screen">
    ...
    <form onSubmit={(e) => {
      ...
      <div className="flex justify-center items-center gap-x-2.5 w-full">
        <input className=" shrink grow basic-auto bg-neutral-200 h-7.5  rounded-md px-2.5 py-0" type="text" placeholder="Nhập tên" onChange={(e) => {
                console.log(e.target.value);
              }} />
        <input  className=" shrink grow basic-auto bg-neutral-200 h-7.5 rounded-md px-2.5 py-0"type="text " placeholder="Nhập số điện thoại" onChange={(e) => {
                console.log(e.target.value);
              }} />
      ...
      <input  className=" shrink grow basic-auto bg-neutral-200 px-2.5 py-0 h-7.5 rounded-md" type="text" placeholder="Tìm kiếm" onChange={(e) => {
                console.log(e.target.value);
              }}/>
